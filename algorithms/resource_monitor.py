...
class ResourceMonitor:
    ...
    def _monitor(self):
        ...
        while self._running:
            ...
            next_time = self.start_time + ((int(elapsed / self.interval) + 1) * self.interval)
    ...
    def save_log(self, filename="resource_log.csv"):
        ...
        with open(filepath, "w") as f:
            ...
            for t, cpu, mem in zip(self.time_log, self.cpu_log, self.mem_log):
...
if __name__ == "__main__":
    ...
    result = [i**2 for i in range(10**7*5)]
